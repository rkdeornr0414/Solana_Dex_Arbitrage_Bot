...
import { p as ApiV3PoolInfoConcentratedItem, d as ApiClmmConfigInfo, i as ApiV3Token, bY as GetTransferAmountFee, bX as TransferAmountFee, cj as Price, ci as Percent, ce as TokenAmount, bU as ComputeBudgetConfig, bV as TxTipConfig, cg as Fraction, bK as TokenInfo, D as ClmmKeys } from './api-f871a7d4.js';
...
declare class TickUtils {
    ...
    static getInitializedTickArrayInRange(tickArrayBitmap: BN__default[], exTickArrayBitmap: ReturnType<typeof TickArrayBitmapExtensionLayout.decode>, tickSpacing: number, tickArrayStartIndex: number, expectedCount: number): number[];
    static getAllInitializedTickArrayStartIndex(tickArrayBitmap: BN__default[], exTickArrayBitmap: ReturnType<typeof TickArrayBitmapExtensionLayout.decode>, tickSpacing: number): number[];
    static getAllInitializedTickArrayInfo(programId: PublicKey, poolId: PublicKey, tickArrayBitmap: BN__default[], exTickArrayBitmap: ReturnType<typeof TickArrayBitmapExtensionLayout.decode>, tickSpacing: number): {
        tickArrayStartIndex: number;
        tickArrayAddress: PublicKey;
    }[];
    static getAllInitializedTickInTickArray(tickArray: TickArrayState): TickState[];
    static searchLowBitFromStart(tickArrayBitmap: BN__default[], exTickArrayBitmap: ReturnType<typeof TickArrayBitmapExtensionLayout.decode>, currentTickArrayBitStartIndex: number, expectedCount: number, tickSpacing: number): number[];
    static searchHightBitFromStart(tickArrayBitmap: BN__default[], exTickArrayBitmap: ReturnType<typeof TickArrayBitmapExtensionLayout.decode>, currentTickArrayBitStartIndex: number, expectedCount: number, tickSpacing: number): number[];
...
declare type ClmmParsedRpcData = ReturnType<typeof PoolInfoLayout.decode> & {
    currentPrice: number;
    programId: PublicKey;
};
...
export { ApiClmmPoint as A, InitRewardExtInfo as B, ClmmConfigInfo as C, DecreaseLiquidity as D, ClmmParsedRpcData as E, ClmmLockAddress as F, GetAmountParams as G, HarvestLockPosition as H, IncreasePositionFromLiquidity as I, TICK_ARRAY_BITMAP_SIZE as J, ReturnTypeGetTickPrice as K, LockPosition as L, ManipulateLiquidityExtInfo as M, ReturnTypeGetPriceAndTick as N, OpenPositionFromBase as O, Tick as P, TickArray as Q, ReturnTypeMakeHarvestTransaction as R, SDKParsedConcentratedInfo as S, TICK_ARRAY_SIZE as T, UserPositionAccount as U, TickState as V, TickArrayState as W, TickUtils as X, ApiClmmConfigInfos as a, ClmmPoolRewardInfo as b, ClmmPoolInfo as c, ComputeClmmPoolInfo as d, ClmmPoolPersonalPosition as e, ReturnTypeMakeCreatePoolTransaction as f, ReturnTypeGetLiquidityAmountOut as g, ReturnTypeGetAmountsFromLiquidity as h, ReturnTypeComputeAmountOutFormat as i, ReturnTypeComputeAmountOut as j, ReturnTypeComputeAmountOutBaseOut as k, ReturnTypeFetchMultiplePoolTickArrays as l, CreateConcentratedPool as m, IncreasePositionFromBase as n, OpenPositionFromBaseExtInfo as o, OpenPositionFromLiquidity as p, OpenPositionFromLiquidityExtInfo as q, InitRewardParams as r, InitRewardsParams as s, SetRewardParams as t, SetRewardsParams as u, CollectRewardParams as v, CollectRewardsParams as w, HarvestAllRewardsParams as x, ReturnTypeFetchExBitmaps as y, ClosePositionExtInfo as z };
