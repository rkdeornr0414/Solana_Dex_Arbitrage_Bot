...
function initializeRewardV2Ix(program, params) {
    const { rewardAuthority, funder, whirlpool, rewardMint, rewardTokenBadge, rewardIndex, rewardTokenProgram, } = params;
    const rewardVault = "rewardVaultKeypair" in params
