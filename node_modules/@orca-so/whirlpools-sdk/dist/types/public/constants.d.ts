...
export declare const FEE_RATE_HARD_LIMIT = 100000;
export declare const VOLATILITY_ACCUMULATOR_SCALE_FACTOR = 10000;
export declare const REDUCTION_FACTOR_DENOMINATOR = 10000;
export declare const ADAPTIVE_FEE_CONTROL_FACTOR_DENOMINATOR = 100000;
export declare const MAX_REFERENCE_AGE = 3600;
