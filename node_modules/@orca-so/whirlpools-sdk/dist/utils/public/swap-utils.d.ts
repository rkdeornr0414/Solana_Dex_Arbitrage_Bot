...
export declare const NO_ORACLE_DATA: null;
export declare class SwapUtils {
    ...
    static getOracle(programId: PublicKey, whirlpoolAddress: PublicKey, fetcher: WhirlpoolAccountFetcherInterface, opts?: WhirlpoolAccountFetchOptions): Promise<OracleData | null>;
