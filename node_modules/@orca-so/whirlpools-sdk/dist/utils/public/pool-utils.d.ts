...
import type { WhirlpoolContext, WhirlpoolExtensionSegmentPrimary, WhirlpoolExtensionSegmentSecondary } from "../..";
export declare class PoolUtil {
    static isRewardInitialized(rewardInfo: WhirlpoolRewardInfoData): boolean;
    static getRewardAuthority(pool: WhirlpoolData): PublicKey;
    static getExtensionSegmentPrimary(pool: WhirlpoolData): WhirlpoolExtensionSegmentPrimary;
    static getExtensionSegmentSecondary(_pool: WhirlpoolData): WhirlpoolExtensionSegmentSecondary;
