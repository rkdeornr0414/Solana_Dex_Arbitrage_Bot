...
class PoolUtil {
    ...
    static getRewardAuthority(pool) {
        return new web3_js_1.PublicKey(pool.rewardInfos[0].extension);
    }
    static getExtensionSegmentPrimary(pool) {
        const extension = Buffer.from(pool.rewardInfos[1].extension);
        const controlFlags = __1.FlagUtil.u16ToWhirlpoolControlFlags(extension.readUint16LE(0));
        return {
            controlFlags,
        };
    }
    static getExtensionSegmentSecondary(_pool) {
        return {};
    }
