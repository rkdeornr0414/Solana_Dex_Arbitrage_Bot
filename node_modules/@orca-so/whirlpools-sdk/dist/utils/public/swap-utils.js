...
exports.SwapUtils = exports.NO_ORACLE_DATA = void 0;
...
class SwapUtils {
    ...
    static async getOracle(programId, whirlpoolAddress, fetcher, opts) {
        const oracleAddress = pda_utils_1.PDAUtil.getOracle(programId, whirlpoolAddress).publicKey;
        const oracleData = await fetcher.getOracle(oracleAddress, opts);
        if (!oracleData) {
            return exports.NO_ORACLE_DATA;
        }
        return oracleData;
    }
