...
class WhirlpoolClientImpl {
    ...
    async createSplashPool(whirlpoolsConfig, tokenMintA, tokenMintB, initialPrice = new decimal_js_1.default(1), funder, opts = fetcher_1.PREFER_CACHE) {
        ...
        const feeTierKey = public_2.PDAUtil.getFeeTier(this.ctx.program.programId, whirlpoolsConfig, public_1.SPLASH_POOL_TICK_SPACING).publicKey;
        const whirlpoolPda = public_2.PDAUtil.getWhirlpool(this.ctx.program.programId, whirlpoolsConfig, new web3_js_1.PublicKey(tokenMintA), new web3_js_1.PublicKey(tokenMintB), public_1.SPLASH_POOL_TICK_SPACING);
        ...
        const initSqrtPrice = public_2.PriceMath.priceToSqrtPriceX64(initialPrice, tokenDecimalsA, tokenDecimalsB);
        ...
        const tokenBadgeA = public_2.PDAUtil.getTokenBadge(this.ctx.program.programId, whirlpoolsConfig, common_sdk_1.AddressUtil.toPubKey(tokenMintA)).publicKey;
        const tokenBadgeB = public_2.PDAUtil.getTokenBadge(this.ctx.program.programId, whirlpoolsConfig, common_sdk_1.AddressUtil.toPubKey(tokenMintB)).publicKey;
        const baseParams = {
            initSqrtPrice,
            whirlpoolsConfig,
            whirlpoolPda,
            ...
            tokenVaultBKeypair,
            feeTierKey,
            tickSpacing: public_1.SPLASH_POOL_TICK_SPACING,
        ...
        const [startTickIndex, endTickIndex] = public_2.TickUtil.getFullRangeTickIndex(public_1.SPLASH_POOL_TICK_SPACING);
        const startInitializableTickIndex = public_2.TickUtil.getStartTickIndex(startTickIndex, public_1.SPLASH_POOL_TICK_SPACING);
        const endInitializableTickIndex = public_2.TickUtil.getStartTickIndex(endTickIndex, public_1.SPLASH_POOL_TICK_SPACING);
        const startTickArrayPda = public_2.PDAUtil.getTickArray(this.ctx.program.programId, whirlpoolPda.publicKey, startInitializableTickIndex);
        const endTickArrayPda = public_2.PDAUtil.getTickArray(this.ctx.program.programId, whirlpoolPda.publicKey, endInitializableTickIndex);
        txBuilder.addInstruction((0, instructions_1.initDynamicTickArrayIx)(this.ctx.program, {
