...
export declare class WhirlpoolImpl implements Whirlpool {
    ...
    openPosition(tickLower: number, tickUpper: number, liquidityInput: IncreaseLiquidityInput, wallet?: Address, funder?: Address, positionMint?: PublicKey, tokenProgramId?: PublicKey, resolveATA?: boolean): Promise<{
        positionMint: PublicKey;
        tx: TransactionBuilder;
    }>;
    openPositionWithMetadata(tickLower: number, tickUpper: number, liquidityInput: IncreaseLiquidityInput, sourceWallet?: Address, funder?: Address, positionMint?: PublicKey, tokenProgramId?: PublicKey, resolveATA?: boolean): Promise<{
        positionMint: PublicKey;
        tx: TransactionBuilder;
    }>;
    ...
    getOpenPositionWithOptMetadataTx(tickLower: number, tickUpper: number, liquidityInput: IncreaseLiquidityInput, wallet: PublicKey, funder: PublicKey, tokenProgramId: PublicKey, withMetadata?: boolean, positionMint?: PublicKey, resolveATA?: boolean): Promise<{
        positionMint: PublicKey;
        tx: TransactionBuilder;
    }>;
