...
class WhirlpoolContext {
    ...
    txBuilderOpts;
    accountResolverOpts;
    static from(connection, wallet, fetcher = (0, public_1.buildDefaultAccountFetcher)(connection), lookupTableFetcher, opts = {}) {
        ...
        const program = new anchor_1.Program(whirlpool_json_1.default, anchorProvider);
    ...
    static withProvider(provider, fetcher = (0, public_1.buildDefaultAccountFetcher)(provider.connection), lookupTableFetcher, opts = {}) {
        const program = new anchor_1.Program(whirlpool_json_1.default, provider);
        return new WhirlpoolContext(provider, provider.wallet, program, fetcher, lookupTableFetcher, opts);
    }
